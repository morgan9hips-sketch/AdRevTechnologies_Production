      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-12 w-full max-w-6xl">
            <div className="flex flex-col items-center gap-5 lg:grid lg:grid-cols-[minmax(0,1fr)_210px] lg:items-start lg:gap-5">
              <div className="w-full">
                <RevenueCalculator />
              </div>

              <aside className="w-full max-w-[210px] rounded-[22px] border border-[#c9d8e2]/70 bg-[linear-gradient(180deg,rgba(244,249,252,0.98),rgba(223,236,242,0.94))] p-3 text-center shadow-[0_16px_40px_rgba(2,6,15,0.16)] backdrop-blur lg:justify-self-end">
                <div className="text-[0.65rem] font-semibold uppercase tracking-[0.24em] text-[#0d4568]">
                  Fact
                </div>

                <div className="mt-3 space-y-2 text-left">
                  <p className="rounded-lg border border-[#dce7ee] bg-white/76 px-2.5 py-2 text-[12px] font-medium leading-5 text-[#13324b]">
                  ...
                  <p className="rounded-lg border border-[#dce7ee] bg-white/76 px-2.5 py-2 text-[12px] font-medium leading-5 text-[#13324b]">
                    High engagement often still converts poorly into
                    monetisation.
                  </p>
                </div>

                <div className="my-3 h-px bg-[#c9d8e2]/80" />

                <div className="text-[0.65rem] font-semibold uppercase tracking-[0.24em] text-[#0d4568]">
                  Result
                </div>
                <p className="mt-2 text-sm font-semibold leading-6 text-[#16324a]">
