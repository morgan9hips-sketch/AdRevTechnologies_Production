...
export function FoundingMemberSuccessClient() {
        ...
        <div className="bg-[#0f1629] border border-[#1e2d4a] rounded-2xl p-8 space-y-6">
          ...
          <div className="bg-[#00d4ff]/5 border border-[#00d4ff]/20 rounded-xl p-5">
            <p className="text-sm text-[#f1f5f9] leading-relaxed">
              Your account manager will be in touch within 30–45 days with
              activation updates and platform access details.
            </p>
          </div>

          <p className="text-sm text-[#94a3b8] text-center">
            A confirmation email has been sent to you. For direct support,
            contact{' '}
            <a
              href="mailto:admin@adrevtechnologies.com"
              className="text-[#00d4ff] hover:underline"
